...
from sql.sql_creators import CreatorsSQL
...
readreplic_handle = ReadReplicHandle(readreplic_host, 
                                        ...
                                        readreplic_passwd, 
                                        readreplic_database, 
                                        query=CreatorsSQL.query(),
                                        fields=CreatorsSQL.fields())
dw_handle = DWHandle(dw_host, 
                        dw_port,
                        dw_user,
                        dw_passwd,
                        dw_database)
destination_table = 'creators'
...
# DAG
with DAG(
    dag_id='dag_dw_creators', 
    description="ReadReplic to DW: Creators",
