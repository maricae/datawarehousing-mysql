...
from dags.sql.sql_products import ProductsSQL
...
readreplic_handle = ReadReplicHandle(readreplic_host, 
                                        ...
                                        readreplic_passwd, 
                                        readreplic_database, 
                                        query=ProductsSQL.query(),
                                        fields=ProductsSQL.fields())
...
# DAG
with DAG(
    dag_id='dag_dw_products', 
    description="ReadReplic to DW: Products",
